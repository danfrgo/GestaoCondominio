        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoPostal = table.Column<string>(maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Alugueres", x => x.AluguerId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartamentos_Utilizadores_MoradorId",
                        column: x => x.MoradorId,
                        principalTable: "Utilizadores",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Apartamentos_Utilizadores_ProprietarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servicos_Utilizadores_UtilizadorId",
                        column: x => x.UtilizadorId,
                        principalTable: "Utilizadores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Veiculos_Utilizadores_UtilizadorId",
                        column: x => x.UtilizadorId,
                        principalTable: "Utilizadores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagamentos_Alugueres_AluguerId",
                        column: x => x.AluguerId,
                        principalTable: "Alugueres",
                        principalColumn: "AluguerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pagamentos_Utilizadores_UtilizadorId",
                        column: x => x.UtilizadorId,
                        principalTable: "Utilizadores",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "00a2a0b8-efb2-4a5e-bc06-0a6661af8013", "aa3b7290-dfea-4d7d-875c-bf02cf403eb5", "Morador do Prédio", "Morador", "MORADOR" },
                    { "75643dd5-c78c-4d16-ad90-17e3814590a4", "ee0da1c9-7585-481a-8e27-591be53d0012", "Responsavel do Prédio", "Responsavel", "RESPONSAVEL" },
                    { "89013940-4fcc-4b85-8a1d-3121af1720bb", "3b220cc0-dc24-4636-9e8e-b41d5c182a77", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
