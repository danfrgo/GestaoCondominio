function MontarGraficoLinhasGanhos(ano) {
    ...
    $.ajax({
        ...
        success: function (dados) {
            ...
            new Chart(document.getElementById("GraficoValoresGanhosDespesas"), { // ID da pagina GraficoValoresGanhosDespesas.cshtml
                type: 'line',

                data: {
                    labels: ObterMeses(dados),
                    datasets: [{
                        label: "Ganhos com pagamentos por ano",
                        data: ObterValores(dados),
                        backgroundColor: "#90caf9",
                        borderColor: "#0277bd",
                        fill: true, // vai preenchar o background do grafico
                        lineTension: 0 // grafico sem curvas
                    }]
                },
                ...
                options: {
                    legend: {
                        labels: {
                            usePointStyle: true // a legenda será um ponto redondo
                        }
                    },
                    ...
                    scales: {
                        xAxes: [{
                            gridLines: {
                                display: false // sem as linhas de grid
                            }
                        }]
                    }
                }
